  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 w-full items-center ebox-row">
        ...
        <div className={`flex flex-col items-center justify-center ${contentPosition === "right" ? "order-1" : "order-2"}`}>
          <div className="grid grid-cols-2 gap-4 w-full">
            <div
              className="overflow-hidden shadow-sm image-height-container"
              style={{
